    ...
    export default {
        ...
        computed: {
            ...
            chatGetGameLink() {
                ...
                if(
                    this.message.message.replace(/&#x2F;/g, '/').match(/(bloxygag\.com\/battles\/[0-9a-fA-F]{24})/) !== null ||
                    this.message.message.replace(/&#x2F;/g, '/').match(/(bloxygag\.com\/duels\?game=[0-9a-fA-F]{24})$/) !== null
                ) {
                    link = this.message.message.replace(/&#x2F;/g, '/').replace(/.*bloxygag\.com/, '');
                }
