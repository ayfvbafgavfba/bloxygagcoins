        ...
        <div class="code-inner">
            <div class="inner-info">
                <div class="info-text">
                    ...
                    <div class="text-link">
                        https://bloxygag.com/?a={{ affiliatesData.data !== null && affiliatesData.data.code !== undefined ? affiliatesData.data.code : '' }}
    ...
    export default {
       ...
       methods: {
            ...
            affiliatesCopyButton() {
                ...
                el.value = ' https://bloxygag.com/?a=' + (this.affiliatesData.data !== null && this.affiliatesData.data.code !== undefined ? this.affiliatesData.data.code : '');
