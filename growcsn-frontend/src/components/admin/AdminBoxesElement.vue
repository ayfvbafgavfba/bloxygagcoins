<template>
    <div class="admin-boxes-element">
        ...
        <div class="element-section section-option">
            ...
            <div class="section-content">
                <button class="button-view" v-on:click="adminViewButton()" v-bind:disabled="socketSendLoading === 'AdminBoxRemove'">
                ...
                <button class="button-remove" v-on:click="adminRemoveButton()" v-bind:disabled="socketSendLoading === 'AdminBoxRemove'">
                    REMOVE
                </button>
            </div>
        </div>
...
<style scoped>
    ...
    .admin-boxes-element .element-section.section-option .section-content button.button-remove {
        color: #e27474;
    }

    .admin-boxes-element .element-section.section-option .section-content button.button-remove:hover {
        color: #ff9b9b;
    }
