      ...
      >
        ...
        <div className="Info">
          <div className="List">
            ...
            <p className="ListItem">
              <p className="Title">Can BloxyGAG be rigged?</p>
              <p className="Text">
                BloxyGAG itself has no impact on the outcome of particular games.
            ...
            <p className="ListItem">
              ...
              <p className="Text">
                BloxyGAG takes a cut of 0-10% of every game to keep the site
                functional.
              </p>
            </p>
            <p className="ListItem">
              ...
              <p className="Text">
                In Grow A Garden 2, the market changes a lot. With this, so do
            ...
            <p className="ListItem">
              <p className="Title">
                I am a GAG2 content creator and I am looking for a sponsorship.
              </p>
              <p className="Text">
